...
import {
  StyleSheet, View, Text, ActivityIndicator, Alert, Image, FlatList, PermissionsAndroid, Platform,
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    flexDirection: 'row', justifyContent: 'space-between', marginTop: 25, marginBottom: 20
  },
  buttonLabels: {
    color: 'white',
    fontSize: 14,
...
class LeaveCancelApprovalRejectScreen extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    const response = await getDynamicFieldsData('5',
      ...
      'ESS_Inbox_LeaveCancel$[2001AbsenceData]',
      this.props.user);
          ...
          // eslint-disable-next-line no-console
            ...
            .then((resp) => {
              ...
              Alert.alert(
                ...
                [
                  { text: 'OPEN', onPress: () => console.log('Ask me later pressed') },
                  {
                    text: 'CANCEL',
                    onPress: () => {},
                    style: 'cancel',
      ...
      >
        <View style={styles.mainContainer}>
          ...
          <View style={styles.horizontalContainer}>
            <Card style={[styles.cards, { width: '48%', borderRadius: 5 }]}>
              <View style={styles.cardMenuSpasing}>
                <Text style={[styles.cardLabel, { color: secondaryColor }]}>
                  From Date
                </Text>
...
export default connect(
  mapStateToProps,
)(LeaveCancelApprovalRejectScreen);
